...
//
// AppState shape, initial values, and small pure helpers live in app-state.ts
// so render modules under components/ can import the types without pulling
// in the backend wiring.
...
export type { AppState, Screen, SendMessageRequest, ViewSummary } from './app-state.js'
export type { InstalledAgent, AgentMeta, RemoteAgentConfig } from './agent-meta.js'
