...
const Channel = {
  ...
  FIND: 'agentwfy:find',
  GREP: 'agentwfy:grep',
  LIST_SESSIONS: 'agentwfy:listSessions',
  READ_SESSION: 'agentwfy:readSession',
  WRITE_SESSION: 'agentwfy:writeSession',
  READ_AUTH_CONFIG: 'agentwfy:readAuthConfig',
  WRITE_AUTH_CONFIG: 'agentwfy:writeAuthConfig',
  READ_LEGACY_API_KEY: 'agentwfy:readLegacyApiKey',
